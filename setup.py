...
if os.environ.get("LLMSTUDIO_PY_BUILDFUN_COMPILE_MYPYC") == "1":
...
def get_ext_modules():
    ...
    If the `LLMSTUDIO_PY_BUILDFUN_COMPILE_MYPYC` environment variable is set to "1",
    ...
    if os.environ.get("LLMSTUDIO_PY_BUILDFUN_COMPILE_MYPYC") == "1":
        ...
        # For example:
        # return mypycify([
        #     "src/llmstudio_py_buildfun/__main__.py",
        #     "src/llmstudio_py_buildfun/some_other_module.py",
        # ])
        return mypycify(
            [
                "src/llmstudio_py_buildfun/__main__.py",
